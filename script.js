...
const switcher = document.querySelectorAll(".switch"); //GET THE SWITCHER
...
addons.forEach((addon) => {
	addon.addEventListener("click", (e) => {
		const addonsSelect = addon.querySelector("input");
...
function showAddon(ad, val) {
	const temp = document.getElementByTagName("template")[0];
